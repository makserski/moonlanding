...
tstart=0; %time 0
dt=0.1; %timestep
t1=490; %time of stage 1 burn
g= 1.62; % g
F = 16000; % stage 1 thrust
M_moon_launch = 4700; % initial mass of ship
...
for t = tstart:dt:t1
    ...
    v=v+dt*a;
    M_moon_launch = M_moon_launch - massflow1;
    matrixmoon = updatetable(s,a,v,h,angle,hh,totalT,matrixmoon,M_moon_launch);
    totalT=totalT+dt;
    s=1+s;
